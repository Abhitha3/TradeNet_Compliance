    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ComplianceNotification>().HasData(
                ...
                new ComplianceNotification { Id = 4, Title = "Audit Due Today", Description = "Scheduled audit for Gamma Exports is due.", AlertType = "AuditDue", Severity = "Medium", IsRead = true, CreatedAt = seedDate.AddDays(15), AssignedOfficerId = 1 },
